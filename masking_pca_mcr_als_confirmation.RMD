...
grouping_VNIR_files<-function(){
  spectral_files<-list.files(path='D:/VNIR', pattern='raw_rd_rf$', recursive=TRUE, full.names= TRUE)
...
```
```{r}
launching_analysis<-function(group1, group2){
